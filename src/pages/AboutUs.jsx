  ...
  return (
    <div className="bg-[#F5F5F5] flex flex-col relative min-h-screen pb-20 w-full poppins-bold">
      ...
      <div className="md:mx-20 flex flex-col z-30 mt-20">
        <div className="mt-10 w-full flex flex-col">
          <div className="flex flex-row items-center text-center justify-center md:mx-0 mx-3 w-full my-10 "  >
            ...
            <h2 className=" font-bold md:text-[56px] text-[#373D3B] text-3xl md:px-14 poppins-bold z-10">About Zenone Studioz</h2>
          </div>
          <FadeinAnimation>
      ...
      <div className="relative h-[550px] mt-20">
        <div className='absolute bg-[#1C39BB] h-3 w-full z-20'></div>
        ...
        <div className='absolute bottom-0 bg-[#1C39BB] h-3 w-full z-20'></div>
