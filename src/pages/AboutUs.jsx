...
import { AboutUs1, BgDotsBoth, FilmCam, HeroSectionBg3 } from '../assets/photos';
...
const AboutUs = () => {
    ...
    return (
        <div className="bg-[#fff9f3] relative min-h-screen pb-20 w-full timesNew">
            ...
            <div className=" absolute inset-0 overflow-hidden z-10 top-[500px]">
                <img
                    src={FilmCam}
                    alt="Moving Element"
                    className="left-0 w-[500px] h-[500px]"
                    style={{
                        transform: `translateX(${scrollY * 0.5}px) scale(${1 + scrollY / 700})`,
            ...
            <div className="md:mx-24 ">
                ...
                <div className="mt-10">
                    <div className="flex flex-row items-center ">
                        ...
                        <h2 className="text-3xl font-bold text-black md:w-[179.8px] z-30">Our Mission</h2>
                    </div>
                    <p className="mt-4 text-gray-600 z-30">
