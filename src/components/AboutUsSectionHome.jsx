        ...
        <section className="  relative w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="container flex flex-col items-center w-full">
                <div className="relative w-full h-screen flex flex-col ">
                    ...
                    <div className="w-screen h-[250px] relative mt-6 mb-6">
                        ...
                        <img
                            src={CaveArt2}
                            alt="Img"
                            className='absolute h-[280px] drop-shadow-xl inset-0 object-contain z-10 right-0'
                        />
                    </div>
                    <div className='flex md:mx-40 mx-3 my-10 text-center'>
                        <FadeinAnimation>
                ...
                <div className="relative w-full h-screen pb-8 z-30">
                    <div
                        className="absolute inset-0 z-0 w-full"
                        style={{
                    ...
                    <div className='flex md:mx-40 text-center mx-3'>
                        <FadeinAnimation>
                            <Slide direction="down" duration={1000}>
                                ...
                                <h6 className="mt-4 text-[#708090] open-sans-regular text-base md:text-xl z-20">
